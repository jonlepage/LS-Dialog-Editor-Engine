...
namespace LsdeDialogEngine.Newtonsoft.Tests
{
    public class LsdeJsonTests
    {
        ...
        [Fact]
        public void Settings_ArePreconfigured()
        {
            var settings = LsdeJson.Settings;
            Assert.NotNull(settings);
            Assert.True(settings.Converters.Count >= 1, "Should have BlueprintBlockNewtonsoftConverter");
        }
    }
}
