...
| ------------------------------- | ---------- | ------------------------ | ------- |
| [lsde-ts](lsde-ts/)             | TypeScript | Reference implementation | 306/306 |
| [lsde-csharp](lsde-csharp/)     | C#         | Unity, .NET              | 107/107 |
| [lsde-cpp](lsde-cpp/)           | C++        | Unreal, custom engines   | 95/95   |
| [lsde-gdscript](lsde-gdscript/) | GDScript   | Godot 4                  | 91/91   |
