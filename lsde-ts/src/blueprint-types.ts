// LSDE Dialog Engine — the payload contract, generated by LSDE. DO NOT EDIT.
//
// Copied verbatim from the `<Project>.blueprints.types.ts` an LSDE export writes next to its
// JSON — the same description generates the C#, C++ and GDScript headers, so the four runtimes
// cannot drift on a field name. To refresh it: copy the file out of a fresh export, drop the
// project-specific alias at the bottom, keep this header.
//
// Reference export: mock/blueprints/ — LSDE 2.0.3, format "lsde-blueprints" version 1.
//
