...
const labels: Record<string, Record<string, string>> = {
	"": {
		...
		router: "The Router Block",
		characterDistribution: "Distributing Characters",
		handlers: "Handlers",
	...
	"/ja": {
		...
		blockTypes: "ブロックタイプ",
		router: "Router block",
		characterDistribution: "登場人物の割り当て",
		handlers: "ハンドラー",
	...
	"/fr": {
		...
		router: "Le bloc Router",
		characterDistribution: "Distribuer les personnages",
		handlers: "Handlers",
	...
	return [
		...
		},
		{
			...
			items: [
				...
				{ text: l.router, link: `${prefix}/guide/router` },
				{ text: l.characterDistribution, link: `${prefix}/guide/character-distribution` },
